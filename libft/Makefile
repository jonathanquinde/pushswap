...
HEADERS = include/file.h include/libft.h
...
SRC_ADT = ADT/queue.c
SRC_FILE = ft_raw_rreadtext.c ft_readtext.c ft_rreadlines.c
OBJ = $(SRC:.c=.o)
OBJ_ADT = $(SRC_ADT:.c=.o)
...
$(NAME): $(OBJ) $(OBJ_ADT) $(OBJ_FILE)
	ar rcs $(NAME) $(OBJ) $(OBJ_ADT) $(OBJ_FILE)
